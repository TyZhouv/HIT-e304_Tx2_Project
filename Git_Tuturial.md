...
>（1）每一次 git commit 都会生成一个版本，记录文件的增添和修改  
>（2）可以切换至每一个历史版本  
>2. 多人协作开发：强大的分支管理系统支持分支合并、差异对比  
>（1）可以生成分支共同开发，开发完成后 git merge合并。如果git merge 有冲突用可视化工具解决  
>（2）分支主要有feature分支、bug分支  
...
>
> *（3）在Repository中将 main branch 从 main 更换为 master*  ，不更换的话要设置main分支推送人
> 
